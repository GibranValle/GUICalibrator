...
def create_main_frame(self):
    ...
    self.serial_config = CTkButton(self.frame_main, command=self.generic.display_serial_frame, font=self.font_text, text='Serial config')
    ...
    self.utils_menu = CTkButton(self.frame_main, command=self.generic.display_utils_frame, font=self.font_text, text='Utils')
