...
class Manual:
    ...
    def create_manual_frame(self):
        ...
        gui.start_button_m = CTkButton(gui.frame_buttons, command=lambda: self.pushed('start'), font=gui.font_text, width=WIDTH_3, text=PLAY, text_color_disabled=DISABLED_COLOR)
        gui.start_button_m.grid(row=0, column=1)
        gui.pause_button_m = CTkButton(gui.frame_buttons, command=lambda: self.pushed('pause'), font=gui.font_text, width=WIDTH_3,
        ...
        gui.stop_button_m = CTkButton(gui.frame_buttons, command=lambda: self.pushed('stop'), font=gui.font_text, width=WIDTH_3,
        ...
        gui.main_menu = CTkButton(gui.frame_manual, command=gui.generic.back2main, font=gui.font_text, text='Main menu', fg_color=ERR_COLOR, hover_color=ERR_COLOR_HOVER)
